...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMaster" Runat="Server">
    ...
    <div>
        <h1>Pomognite developerima</h1>
        <hr />
        <p>U slučaju otkrića buga, errora ili druge greške molimo Vas da obavijestite developere kako bismo čim prije uklonili greške.</p>
        <p>Srdačno team Ritehpedia</p>
        <hr />
    </div>
</asp:Content>
